...
class _PageOneState extends State<PageOne> {
  ...
  TextEditingController routeControler = new TextEditingController();
  TextEditingController passengersControler = new TextEditingController();
  TextEditingController fareControler = new TextEditingController();
  TextEditingController stationControler = new TextEditingController();
  TextEditingController driverControler = new TextEditingController();
  TextEditingController conductorControler = new TextEditingController();
  TextEditingController numberPlateControler = new TextEditingController();
  String url = 'https://prodevmatatu.herokuapp.com/api/trip';
  Future<String> makeRequest() async {
    var response = await http
        .post(Uri.encodeFull(url), body: json.encode({

      "driver": "John Kariamiti",
      "conductor": "Peter Maloba",
      "route": "Kasarani",
      "passengers": 42,
      "staff_name": "Moses Wanyama",
      "station": "Kona Mbaya",
      "fare": "50"
  ...
  Widget build(BuildContext context) {
    ...
    final txtPassengers = TextFormField(
      autocorrect: false,
      controller: passengersControler,
      decoration: InputDecoration(
