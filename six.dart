      ...
      return Scaffold(
        ...
        body: ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return ListTile(
              title: Text(trip.route = null? trip.route: 'default value'),

              subtitle: Text(trip.staffName = null? trip.staffName: 'default value'),
...
class TripRepository {
  ...
  static Future<List<Trip>> fetchAll() async {
    ...
    if (response.statusCode == 200) {
      ...
      print(data);
      final trips = (data['data'] as List).map((i) => new Trip.fromJson(i));
      print(trips);
      return trips.toList();
